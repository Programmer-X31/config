...
myBrowser :: String
myBrowser = "google-chrome-stable"  -- Sets brave as browser

myFileManager :: String
myFileManager = "dolphin"  -- Sets Dolphin as browser

myEmacs :: String
myEmacs = "emacsclient -c -a 'emacs' "  -- Makes emacs keybindings easier to type

myEditor :: String
myEditor = "emacsclient -c -a 'emacs' "  -- Makes emacs keybindings easier to type

myEditor_two :: String
myEditor_two = "code"  -- Sets code as editor
...
myStartupHook = do
    ...
    spawnOnce "trayer --edge top --align right --widthtype request --padding 1 --SetDockType true --SetPartialStrut true --expand true --monitor 1 --transparent true --alpha 0 --tint 0x282c34  --height 28 &"
    -- spawnOnce "~/.fehbg &"  -- set last saved feh wallpaper
    -- spawnOnce "feh --randomize --bg-fill ~/wallpapers/*"  -- feh set random wallpaper
    -- spawnOnce "nitrogen --restore &"   -- if you prefer nitrogen to feh
    setWMName "Lenovo IdeaPad"
...
myAppGrid = [ ("Kvantum Manager", "kvantummanager")
...
myManageHook = composeAll
    ...
    , title =? "New Tab - Brave"     --> doShift ( myWorkspaces !! 1 )
    , title =? "React App - Brave"   --> doShift ( myWorkspaces !! 1 )
    , className =? "falkon"          --> doShift ( myWorkspaces !! 2 )
...
myKeys =
    ...
    -- launch dmenu_run, so I've decided to use M-p plus KEY for these dmenu scripts.
        ...
        , ("M-b", spawn (myBrowser))
        , ("M-e 1", spawn (myEditor))
        , ("M-e 2", spawn (myEditor_two))
        , ("M-m", spawn "falkon \"meet.google.com\"")
        , ("M-f", spawn (myFileManager))
        , ("M-x", spawn "lxappearance")
        , ("M-q", spawn "qt5ct")
        , ("M-a", spawn "pavucontrol")
        , ("M-v", spawn "kvantummanager")
    ...
    xmonad $ ewmh def
        ...
        , logHook = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP
              ...
              { ppOutput = \x -> hPutStrLn xmproc x   -- xmobar on monitor 1
                -- Current workspace
              , ppCurrent = xmobarColor "#ff78ac" "" . wrap
                            ("<box type=Bottom width=2 mb=2 color=" ++ color06 ++ ">") "</box>"
                -- Visible but not current workspace
              , ppVisible = xmobarColor  "#ff78ac" "" . clickable
                -- Hidden workspace
